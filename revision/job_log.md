...
### time: Apoly and Acura (24.4)
```bash
nohup r8s -b -f r8s_ctl_file_3.txt > r8s_tmp_3.txt &
# [1] 27521
tail -n 1 r8s_tmp_3.txt | cut -c 16- > r8s_ultrametric_3.txt
less r8s_ultrametric_3.txt|perl -alne 's/0\.000000/0\.000001/g;s/p21mp\d//ig;print' >r8s_ultrametric_3_1.txt
mv r8s_ultrametric_3_1.txt r8s_ultrametric_3.txt
mkdir sec
cd sec
cp -r ../OG0033097_trait ./
cp ../temp1.pl ../temp2.pl ./
cd OG0033097_trait
bamm -c traitcontrol.txt
cd ../
```

### time: Apoly, Acura, Pmol, Padel, Daru (109.38 Mya) && Apoly Acura (24.4 Mya)
```bash
nohup r8s -b -f r8s_ctl_file_5.txt > r8s_tmp_5.txt &
# [1] 21720
tail -n 1 r8s_tmp_5.txt | cut -c 16- |perl -alne 's/0\.000000/0\.000001/g;s/p21mp\d//ig;print' >r8s_ultrametric_5.txt
mkdir five
cd five
cp ../r8s_ultrametric_5.txt ./
cp ../sec/*pl ../sec/PNG.TPM.TMM.sqrt.matrix ./
cp -r ../OG0033097_trait ./
cp r8s_ultrametric_5.txt OG0033097_trait/

```

### time: Pmol, Padel (6.86 Mya) 
```bash
r8s -b -f r8s_ctl_file_4.txt > r8s_tmp_4.txt
mkdir four
tail -n 1 r8s_tmp_4.txt | cut -c 16- |perl -alne 's/0\.000000/0\.000001/g;print' >r8s_ultrametric_4.txt
cp sec/*pl sec/PNG.TPM.TMM.sqrt.matrix four
```

### Apoly, Acura, Pmol, Padel, Daru (56.17 Mya)
```bash
nohup r8s -b -f r8s_ctl_file_1.txt > r8s_tmp_1_1.txt &
# [1] 28934
tail -n 1 r8s_tmp_1_1.txt | cut -c 16- |perl -alne 's/0\.000000/0\.000001/g;s/p21mp\d//ig;print' >r8s_ultrametric_1_1.txt
cd 1_1;cp ../r8s_ultrametric_1_1.txt ./
perl temp2.pl --genes OG0015521 OG0020241 OG0011939 OG0002874 OG0007437 OG0004968 OG0020625 OG0022213 OG0004329 OG0011340 OG0033097 --tree r8s_ultrametric_1_1.txt


nohup r8s -b -f r8s_ctl_file_6.txt > r8s_tmp_6.txt &
# [2] 29062
tail -n 1 r8s_tmp_6.txt | cut -c 16- |perl -alne 's/0\.000000/0\.000001/g;s/p21mp\d//ig;print' >r8s_ultrametric_6.txt
cp r8s_ultrametric_6.txt six/
perl temp2.pl --genes OG0015521 OG0020241 OG0011939 OG0002874 OG0007437 OG0004968 OG0020625 OG0022213 OG0004329 OG0011340 OG0033097 --tree r8s_ultrametric_6.txt

nohup r8s -b -f r8s_ctl_file_7.txt > r8s_tmp_7.txt &
# [1] 27203
tail -n 1 r8s_tmp_7.txt | cut -c 16- |perl -alne 's/0\.000000/0\.000001/g;s/p21mp\d//ig;print' >r8s_ultrametric_7.txt
mkdir seven
cp r8s_ultrametric_7.txt seven/
cd seven/
perl temp2.pl --genes OG0015521 OG0020241 OG0011939 OG0002874 OG0007437 OG0004968 OG0020625 OG0022213 OG0004329 OG0011340 OG0033097 --tree r8s_ultrametric_7.txt

nohup r8s -b -f r8s_ctl_file_8.txt > r8s_tmp_8.txt &
# [2] 8491
tail -n 1 r8s_tmp_8.txt | cut -c 16- |perl -alne 's/0\.000000/0\.000001/g;s/p21mp\d//ig;print' >r8s_ultrametric_8.txt
mkdir eight
cp r8s_ultrametric_8.txt eight/
cd eight
cp ../seven/temp2.pl ./
perl temp2.pl --genes OG0015521 OG0020241 OG0011939 OG0002874 OG0007437 OG0004968 OG0020625 OG0022213 OG0004329 OG0011340 OG0033097 --tree r8s_ultrametric_8.txt

nohup r8s -b -f r8s_ctl_file_9.txt > r8s_tmp_9.txt &
# [3] 20367
tail -n 1 r8s_tmp_9.txt | cut -c 16- |perl -alne 's/0\.000000/0\.000001/g;s/p21mp\d//ig;print' >r8s_ultrametric_9.txt
mkdir nine
cp r8s_ultrametric_9.txt nine/
cd nine
cp ../seven/temp2.pl ./
perl temp2.pl --genes OG0015521 OG0020241 OG0011939 OG0002874 OG0007437 OG0004968 OG0020625 OG0022213 OG0004329 OG0011340 OG0033097 --tree r8s_ultrametric_9.txt
```

```bash
cd first/
cp ../r8s_ultrametric.txt ./
perl temp2.pl --genes OG0018190 OG0047687 OG0047666 OG0042779 OG0003332 OG0009912 OG0013663 OG0004147 OG0000695 OG0001576 OG0008887 OG0028437 OG0003717 OG0037099 OG0002143 OG0027161 OG0013197 --tree r8s_ultrametric_1.txt
```

run 1.sh   
```bash
# OG0015521 OG0020241 OG0011939 OG0002874 OG0007437 OG0004968 OG0020625 OG0022213
perl temp2.pl OG0015521 # S4A4
cd OG0015521_trait/
bamm -c traitcontrol.txt
cd ../
perl temp2.pl OG0020241 # CAH10
cd OG0020241_trait/
bamm -c traitcontrol.txt
cd ../
perl temp2.pl OG0011939 # S4A8
cd OG0011939_trait/
bamm -c traitcontrol.txt
cd ../
perl temp2.pl OG0002874 # CLOCK
cd OG0002874_trait/
bamm -c traitcontrol.txt
cd ../
...
bamm -c traitcontrol.txt
cd ../
perl temp2.pl OG0004329 # KCNQ4
cd OG0004329_trait/
bamm -c traitcontrol.txt
cd ../
perl temp2.pl OG0011340 # CAC1D
cd OG0011340_trait/
bamm -c traitcontrol.txt
```
