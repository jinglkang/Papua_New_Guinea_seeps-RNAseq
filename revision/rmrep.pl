...
foreach my $taxon (@taxa) {
    ...
    my $infile1 = $taxon . "_1.fastq.gz";
    my $infile2 = $taxon . "_2.fastq.gz";
    ...
    open $INFILE1, "zcat $infile1|" or die ("Cannot open $infile1 for reading ($!)");
    open $INFILE2, "zcat $infile2|" or die ("Cannot open $infile2 for reading ($!)");
