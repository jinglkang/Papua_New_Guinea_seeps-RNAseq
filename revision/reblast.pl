...
foreach my $fas (@fas) {
        ...
        `blastn -query $fas -db $database -out blastout/$gene.blast.out.txt -num_threads 22 -word_size 7 -gapopen 5 -gapextend 2 -penalty -1 -reward 1 -evalue 0.000001 -outfmt 6`;
